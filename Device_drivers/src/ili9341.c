 ...
 * The functions in this library is based on Tilen Majerle work.
 * The library has been modified to work my SPI driver library functions also removed functions not needed for this project.
 * Original library: https://github.com/MaJerle/stm32f429/blob/master/00-STM32F429_LIBRARIES/tm_stm32f4_ili9341.c
*/
